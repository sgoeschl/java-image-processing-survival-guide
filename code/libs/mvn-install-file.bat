...
call mvn install:install-file -Dfile=commons-imaging-1.0-20160915.001141-89.jar -Dversion=1.0-20160915.001141-89 -DgroupId=org.apache.commons -DartifactId=commons-imaging -Dpackaging=jar -DcreateChecksum=true -DgeneratePom=true
